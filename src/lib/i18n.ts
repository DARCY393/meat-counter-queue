...
const dictionaries = {
  en: {
    ...
    smsConsentLabel:
      "I agree to receive a text when I am near the front of the line",
    phoneRequiresConsent: "Please check the box to receive SMS updates",
  ...
  es: {
    ...
    smsConsentLabel:
      "Acepto recibir un mensaje de texto cuando esté cerca del frente de la fila",
    phoneRequiresConsent: "Marque la casilla para recibir avisos por SMS",
    invalidPhone: "Ingrese un número de celular válido de EE. UU.",
